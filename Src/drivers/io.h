...
{
    /*
     * MAKE PB10 AND PB11 12C
     * RECONFIGURE I2C TO USE THE RIGHT I2C I THINK I2C2 AND THE GPIO STUFF
     * MAKE PC0 and PC1 UNUSED
     * MAKE PA6->ch1 AND PA7->ch2 MOTOR LEFT CH2 AND CH1
     * LD FRONT RIGHT <-> LD BACK LEFT SWITCH THE PINS
     *
     *
     * PC5->25 AND PB1->27 POSSIBLE ANALOG PINS FOR LD FRONT LEFT AND LD BACK LEFT
     */
